...
Tap the button![](<../../../.gitbook/assets/2-kopiya (3) (3) (2) (12).png>) to open Chart toolbar.
...
In order to add a new indicator, choose the category of indicators (Channels, Moving averages, Oscillators etc.) and tap the button![](<../../../.gitbook/assets/add. (2) (3) (8) (12).jpg>)near the indicator name at the list of available Indicators.

![](<../../../.gitbook/assets/4 (58).png>)

It will appear in ‘Added indicators’ section and you can set indicator’s parameters by tapping the button![](<../../../.gitbook/assets/4 (2).jpg>). Tap the button![](<../../../.gitbook/assets/delete (1) (3) (7) (13).jpg>)located near indicator’s name to remove indicator from this section.
...
The Order entry screen enables user to send orders. The Order entry icon![](<../../../.gitbook/assets/1-kopiya (7) (34).png>) is located at the top right corner of the Chart screen.
