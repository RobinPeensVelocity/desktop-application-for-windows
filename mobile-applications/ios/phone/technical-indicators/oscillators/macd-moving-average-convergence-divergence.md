...
* Fast EMA period –number of periods for calculating the exponential moving average, 9 by default \(classic value for this indicator\);
* Slow EMA period – number of periods for calculating the exponential moving average, 9 by default \(classic value for this indicator\);
* Signal EMA period – defines the period of a signal line, 9 by default.

This indicator looks as follows on the chart:

![](../../../../../.gitbook/assets/macd%20%284%29.jpg)
