...
Tap the button![](<../../../.gitbook/assets/2-kopiya (3) (3) (2) (11).png>)to open Chart toolbar.
...
In order to add a new indicator, choose the category of indicators (Channels, Moving averages, Oscillators etc.) and tap the button![](<../../../.gitbook/assets/add. (2) (3) (8) (1).jpg>)near the indicator name at the list of available Indicators.

![](<../../../.gitbook/assets/3 (87).png>)

It will appear in ‘Added indicators’ section and you can set indicator’s parameters by tapping the button![](<../../../.gitbook/assets/modify (2) (2) (6) (8).jpg>). Tap the button![](<../../../.gitbook/assets/delete (1) (3) (7) (12).jpg>)located near indicator’s name to remove indicator from this section.

![](<../../../.gitbook/assets/4 (59).png>)

Open the chart to see the added indicators.

![](<../../../.gitbook/assets/5 (53).png>)

**Order entry**

The Order entry screen enables user to send orders. The Order entry icon![](<../../../.gitbook/assets/1-kopiya (7) (33).png>)is located at the top right corner of the Chart screen.
...
![](<../../../.gitbook/assets/screenshot\_1 (12).jpg>)
