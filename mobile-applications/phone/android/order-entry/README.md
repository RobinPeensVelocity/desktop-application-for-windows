...
The Order entry screen enables users to send orders. The Order entry button![](<../../../../.gitbook/assets/1-kopiya (7) (3).png>)is located at the top right corner of the Chart screen. Also it is accessible from the main menu located at the bottom of the application or from the Symbol menu. Swipe left the Symbol name in Watchlist to open Symbol menu and tap Order Entry button:
...
In the Order entry panel a user can see the the extended information about the source of Last, Bid and Ask prices. In order to open the table with the detailed information, tap the![](<../../../../.gitbook/assets/ds (1) (1) (2).png>)button and the widget will be shown:
