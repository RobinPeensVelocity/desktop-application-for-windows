...
Select one Color scheme and use the button![](../../../.gitbook/assets/8%20%284%29%20%281%29.png) to add new conditions. For each condition you must select a column type, type of comparison and value to compare.
