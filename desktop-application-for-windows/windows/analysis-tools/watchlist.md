...
![](<../../../.gitbook/assets/menu (5).png>)

The Symbol info window will be opened:

![](<../../../.gitbook/assets/screenshot\_1 (41).jpg>)
...
All information is divided into 6 groups. Each group can be hidden by one click on a group header. The following symbols appear on a header when a group is hidden or opened![](<../../../.gitbook/assets/24 (2).png>).
