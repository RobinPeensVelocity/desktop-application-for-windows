...
Time & Sales can be opened from the Analysis tools menu by clicking on the button ![](../../../../../.gitbook/assets/53%20%284%29.png) or through Context menu -&gt; Analysis tools -&gt; T&S.
